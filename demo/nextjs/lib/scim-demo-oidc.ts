...
const oidcRuntime = globalThis as typeof globalThis & {
	__CinaAuthSCIMDemoOIDCSigningKeys?: Promise<SCIMDemoOIDCSigningKeys>;
};
...
async function getSigningKeys() {
	if (!oidcRuntime.__CinaAuthSCIMDemoOIDCSigningKeys) {
		oidcRuntime.__CinaAuthSCIMDemoOIDCSigningKeys = loadSigningKeys();
	}
	return oidcRuntime.__CinaAuthSCIMDemoOIDCSigningKeys;
}
