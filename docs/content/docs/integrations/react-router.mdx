---
icon: integrationsReactRouter
sidebarTitle: "React Router v7"
title: React Router v7 Integration
description: Integrate CinaAuth with React Router v7 (formerly Remix).
---

CinaAuth can be easily integrated with React Router v7. This guide will show you how to integrate CinaAuth with React Router v7.
...
And in this file, import CinaAuth and create your instance.
...
<Callout type="info">
  You can change the path on your cinaauth configuration but it's recommended to keep it as `routes/api.auth.$.ts`
</Callout>
