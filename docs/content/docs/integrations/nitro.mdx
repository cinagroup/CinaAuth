...
You can now mount the CinaAuth handler in your Nitro application. You can do this by adding the following code to your `server/api/auth/[...all].ts` file:
