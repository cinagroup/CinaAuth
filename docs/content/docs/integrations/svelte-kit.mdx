---
icon: integrationsSvelteKit
sidebarTitle: "SvelteKit"
title: SvelteKit Integration
description: Integrate CinaAuth with SvelteKit.
---
...
export async function handle({ event, resolve }) {
  // Fetch current session from CinaAuth
...
You need to add it as a plugin to your CinaAuth instance.
...
import { sveltekitCookies } from "cinaauth/svelte-kit";
...
import { createAuthClient } from "cinaauth/svelte"; // make sure to import from cinaauth/svelte
