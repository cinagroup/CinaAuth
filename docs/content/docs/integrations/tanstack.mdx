---
icon: integrationsTanStack
sidebarTitle: "TanStack Start"
title: TanStack Start Integration
description: Integrate CinaAuth with TanStack Start.
---
...
You can create a new TanStack Start project with CinaAuth integrated using the following command. This CLI sets up a project with an auth instance configured with the plugin and mounted handlers.
