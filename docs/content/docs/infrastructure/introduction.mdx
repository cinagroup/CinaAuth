---
icon: infrastructureIntroduction
sidebarTitle: "Introduction"
title: CinaAuth Infrastructure
description: Enterprise-grade dashboard, security, and managed services for CinaAuth.
---

CinaAuth Infrastructure is a paid service that extends your authentication system with a management dashboard,
