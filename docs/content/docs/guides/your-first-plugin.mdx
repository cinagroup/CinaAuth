---
icon: guidesYourFirstPlugin
sidebarTitle: "Create Your First Plugin"
title: Create your first plugin
description: A step-by-step guide to creating your first CinaAuth plugin.
---

In this guide, we’ll walk you through the steps of creating your first CinaAuth plugin.

<Callout type="warn">
  This guide assumes you have <Link href="/docs/installation">setup the basics</Link> of CinaAuth and are ready to create your first plugin.
</Callout>
...
<Steps>
  ...
  <Step>
    ...
    CinaAuth plugins operate as a pair: a <Link href="/docs/concepts/plugins#create-a-server-plugin">server plugin</Link> and a <Link href="/docs/concepts/plugins#creating-a-client-plugin">client plugin</Link>.
  ...
  <Step>
    ...
    By creating a schema here, this also allows <Link href="/docs/concepts/cli">CinaAuth’s CLI</Link> to generate the schemas required to update your database.
  ...
  <Step>
    ...
    ```ts title="Imports"
    import { createAuthMiddleware, APIError } from "cinaauth/api";
    ```
...
Congratulations! You’ve successfully created your first ever CinaAuth plugin.
...
our <Link href="https://discord.gg/cinaauth">Discord server</Link>,
or through a <Link href="https://github.com/cinagroup/cinaauth/pulls">pull-request</Link>
