---
icon: referenceContributing
sidebarTitle: "Contributing"
title: Contributing to CinaAuth
description: A concise guide to contributing to CinaAuth
---

Thank you for your interest in contributing to CinaAuth! This guide is a concise guide to contributing to CinaAuth.

## Getting Started

Before diving in, here are a few important resources:

* Take a look at our existing <Link href="https://github.com/cinagroup/cinaauth/issues">issues</Link> and <Link href="https://github.com/cinagroup/cinaauth/pulls">pull requests</Link>
* Join our community discussions in <Link href="https://discord.gg/cinaauth">Discord</Link>
...
<Steps>
  <Step>
    ...
    Visit [https://github.com/cinagroup/cinaauth](https://github.com/cinagroup/cinaauth)
...
<Steps>
  <Step>
    ...
    git remote add upstream https://github.com/cinagroup/cinaauth.git
...
* Check our [GitHub issues](https://github.com/cinagroup/cinaauth/issues) for tasks labeled `good first issue`
...
* Open an <Link href="https://github.com/cinagroup/cinaauth/issues">issue</Link> with questions
* Join our <Link href="https://discord.gg/cinaauth">community discussions</Link>
