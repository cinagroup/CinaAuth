---
icon: pluginsMultiSession
title: Multi Session
description: Learn how to use multi-session plugin in CinaAuth.
---
...
<Steps>
  <Step>
    ...
    import { multiSession } from "cinaauth/plugins"  // [!code highlight]
  ...
  <Step>
    ...
    import { multiSessionClient } from "cinaauth/client/plugins"  // [!code highlight]
...
```ts title="auth.ts"
import { CinaAuth } from "cinaauth"
import { multiSession } from "cinaauth/plugins"
