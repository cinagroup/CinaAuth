...
<Callout type="warn">
  This plugin implements a standard under active development. It is not yet stable and may change in the future. Please report issues on [GitHub](https://github.com/cinagroup/cinaauth/issues).
</Callout>
