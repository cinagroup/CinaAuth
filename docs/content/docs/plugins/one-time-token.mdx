---
icon: pluginsOneTimeToken
sidebarTitle: "One-Time Token"
...
<Steps>
  <Step>
    ...
    import { oneTimeToken } from "cinaauth/plugins/one-time-token"; // [!code highlight]
  ...
  <Step>
    ...
    import { oneTimeTokenClient } from "cinaauth/client/plugins" // [!code highlight]
