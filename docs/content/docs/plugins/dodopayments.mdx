---
icon: pluginsDodoPayments
title: Dodo Payments
description: CinaAuth Plugin for Dodo Payments
---
...
<Steps>
  <Step title="Install dependencies">
    ...
    ```bash
    npm install @dodopayments/cinaauth dodopayments cinaauth zod
    ```
  </Step>
  ...
  <Step title="Set up client-side integration">
    ...
    import { dodopaymentsClient } from "@dodopayments/cinaauth";

    export const authClient = createAuthClient({
      baseURL: process.env.CINAAUTH_URL || "http://localhost:3000",
