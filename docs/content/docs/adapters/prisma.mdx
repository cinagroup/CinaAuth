...
icon: adaptersPrisma
title: Prisma
description: Integrate CinaAuth with Prisma.
---
...
To use the Prisma adapter, install `@cinaauth/prisma-adapter`:
...
Pass the Prisma Client instance to the CinaAuth Prisma adapter:
...
The [CinaAuth CLI](/docs/concepts/cli) generates the Prisma schema required
by your CinaAuth configuration and plugins. Use the Prisma CLI to create and
...
The CinaAuth CLI updates your Prisma schema but does not apply the migration.
Use Prisma to create the database migration, then regenerate Prisma Client:

```bash title="Terminal"
npx prisma migrate dev --name add-cinaauth
npx prisma generate
```
...
* [How to use Prisma ORM with CinaAuth and Next.js](https://www.prisma.io/docs/guides/authentication/better-auth/nextjs)
* [How to use Prisma ORM with CinaAuth and Astro](https://www.prisma.io/docs/guides/authentication/better-auth/astro)
