---
icon: adaptersOtherRelationalDatabases
title: Other Relational Databases
description: Integrate CinaAuth with other relational databases.
---

CinaAuth supports a wide range of database dialects out of the box thanks to <Link href="https://kysely.dev/">Kysely</Link>.

Any dialect supported by Kysely can be utilized with CinaAuth, including capabilities for generating and migrating database schemas through the <Link href="/docs/concepts/cli">CLI</Link>.
