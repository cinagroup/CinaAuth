...
Internationalization plugin for [CinaAuth](https://www.better-auth.com) — translate error messages based on the detected locale.
...
import { i18n, locales } from "@cinaauth/i18n";
...
```ts
import { i18n, locales } from "@cinaauth/i18n";
import type { TranslationDictionary } from "@cinaauth/i18n";
