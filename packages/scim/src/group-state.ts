...
import type { DBAdapter, DBTransactionAdapter } from "cinaauth";
...
type SCIMGroupMutationConflict = CinaAuthError & {
...
function isSCIMGroupMutationConflict(
	...
	return (
		error instanceof CinaAuthError && SCIM_GROUP_MUTATION_CONFLICT in error
	);
}
