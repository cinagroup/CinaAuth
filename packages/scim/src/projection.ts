...
import type { AuthContext, DBAdapter, DBTransactionAdapter } from "cinaauth";
...
type SCIMProjectionSubjectConflict = CinaAuthError & {
...
export function isSCIMProjectionSubjectConflict(
	...
	return (
		error instanceof CinaAuthError && SCIM_PROJECTION_SUBJECT_CONFLICT in error
	);
}
