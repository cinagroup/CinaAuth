...
import { siwe } from "../../cinaauth/src/plugins/siwe-v2";
import { siweClient } from "../../cinaauth/src/plugins/siwe-v2/client";
...
describe("oauth signed query signatures", () => {
	...
	it("should continue OAuth authorization after SIWE v2 verification", async () => {
		...
		const redirectUri = "https://rp.example.com/api/auth/callback";
...
describe("oauth authorize - request_uri resolution", async () => {
	...
	const requestUriWithInvalidMaxAge = "urn:cinaauth:par:invalid-max-age";
	const requestUriWithReorderedPrompt = "urn:cinaauth:par:reordered-prompt";
