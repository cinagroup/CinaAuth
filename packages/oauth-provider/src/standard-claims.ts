...
interface StandardClaimDefinition {
	...
	/** Resolves the claim value from the CinaAuth user. */
...
/**
 * The OIDC Standard Claims (OIDC Core §5.1) that CinaAuth resolves from its
 ...
 * and the bound on requested claim names. Adding a standard claim CinaAuth
