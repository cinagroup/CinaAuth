import type { PrivateKeyJwtSigningAlgorithm } from "@cinaauth/core/oauth2";
...
export interface AuthServerMetadata {
	 ...
	 *
	 * Set at runtime by the `@cinaauth/cimd` plugin (or any other
...
export interface OIDCMetadata extends AuthServerMetadata {
	 ...
	 *
	 * CinaAuth does not advertise this field by default because it does not
