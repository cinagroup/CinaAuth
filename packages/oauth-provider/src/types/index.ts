 ...
 * (such as `@cinaauth/cimd`, which contributes only `clientDiscovery`) sets
...
> {
	 ...
	 * `@cinaauth/cimd` plugin, which verifies client identity through
	 ...
	 * such as `@cinaauth/cimd` contribute their client discovery this way.
	 */
	 ...
	 * not an authorization grant. CinaAuth validates the requested subset,
...
export interface OAuthAuthorizationQuery {
	 ...
	 * `request_not_supported`; CinaAuth does not process Request Objects yet.
	 */
	request?: string;
	/**
