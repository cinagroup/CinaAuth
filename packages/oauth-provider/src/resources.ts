 ...
 * `packages/cinaauth/src/plugins/jwt/types.ts`. Kept as a runtime const
 ...
 * one CinaAuth instance suppress seeding for every later instance in the same
 ...
 * (CinaAuth's test harness, and many deployment setups, run migrations
