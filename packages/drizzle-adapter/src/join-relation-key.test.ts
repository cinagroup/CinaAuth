import type { CinaAuthDBSchema } from "@cinaauth/core/db";
import { initGetDefaultModelName } from "@cinaauth/core/db/adapter";
...
function resolveRelationKey({
	...
	usePlural: boolean;
	databaseSchema?: CinaAuthDBSchema | undefined;
}) {
