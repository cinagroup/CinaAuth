...
import { createResourceServerChallenge } from "@cinaauth/oauth-provider";
import type {
	DpopReplayStore,
...
export interface McpProtectedRequestHandlerOptions {
	...
	jwksUrl?: string;
	/** Retrieves JWKS through a private caller-owned transport. */
	jwksFetch?: VerifyAccessTokenRequestOptions["jwksFetch"];
	/** Stable cache identity for the private JWKS loader. */
	jwksCacheKey?: object;
