...
export interface SSOOptions {
	...
	/**
	 * Resolve a verified provider identity to a CinaAuth user.
	 *
	 ...
	 * CinaAuth converts callback failures into a stable conflict response.
	 */
	 ...
	 *
	 * ! Use this with caution — it can lead to account takeover if misused. Only enable it if users **cannot freely register new providers**. You can
