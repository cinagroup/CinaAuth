...
import type { AuthContext, CinaAuthOptions } from "cinaauth";
...
import { getHttpTestInstance } from "cinaauth/test";
 ...
 */
function interceptSSOProviderLockUpdate<Options extends CinaAuthOptions>(
...
describe("SSO provider read endpoints", () => {
	...
	const createTestAuth = (
		...
		CinaAuthOptions: Pick<CinaAuthOptions, "databaseHooks"> = {},
	) => {
		const data: {
