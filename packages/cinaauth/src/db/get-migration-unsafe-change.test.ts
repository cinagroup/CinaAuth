...
const POSTGRES_CONNECTION_STRING =
	"postgres://user:password@localhost:5433/cinaauth";
...
const MYSQL_CONNECTION_STRING = "mysql://user:password@localhost:3307/cinaauth";
...
function unsafeChangeConfig(database: CinaAuthOptions["database"]) {
	return {
		database,
		plugins: [
			{
