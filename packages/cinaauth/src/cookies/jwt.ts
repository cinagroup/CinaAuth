...
export const SESSION_COOKIE_JWT_TYPE = "cinaauth.session-cache+jwt";
export const SESSION_COOKIE_JWT_AUDIENCE = "cinaauth:session-cache";
export const SESSION_COOKIE_JWT_ISSUER = "cinaauth:session-cache";
