...
import type { CinaAuthClientOptions, ClientFetchOption } from "@cinaauth/core";
...
type VueSessionState<Option extends CinaAuthClientOptions> = DeepReadonly<
	Ref<{
...
type SessionFetchResult<Option extends CinaAuthClientOptions> = {
...
export function createAuthClient<Option extends CinaAuthClientOptions>(
	...
	function useSession(useFetch?: SessionFetch | undefined) {
		...
		// Otherwise, return CinaAuth's session state as a reactive Vue ref.
